sap.ui.define([
	...
	return BaseController.extend("com.sap.dc.controller.App", {
		...
		onItemSelect: function (oEvent) {
          ...
          MessageToast.show(this.getBundleText("clickHandlerMessage", [oItem.getText()]));
		...
		onUserNamePress: function (oEvent) {
          ...
          MessageToast.show(this.getBundleText("clickHandlerMessage", [oEvent.getSource().getText()]));
      ...
      oToggleButton.setTooltip(this.getBundleText(bSideExpanded ? "expandMenuButtonText" : "collpaseMenuButtonText"));
		...
		_createNotification: function (sId, oBindingContext) {
          ...
          MessageToast.show(this.getBundleText("notificationMessageDeleted"));
